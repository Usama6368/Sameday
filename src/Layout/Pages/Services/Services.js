  ...
  const serviceArray = {
    "same-day-courier": [
      ...
      >
        ...
        matter whether you’re a multinational corporation or an small business,
        we’ll collect your time and condition-critical goods within one hour and
        deliver it to any UK destination the same day – guaranteed. Your package
        will be carried by a dedicated vehicle courier with only your goods on
        board, and all consignments are fully insured for your peace of mind.
      </span>,
      <div
        style={{
          color: "black",
      ...
      >
        ...
        too. We can offer confidential document collection and delivery, a same
        day wait and return courier service, same-day heavy goods delivery and
        aviation same-day deliveries. If you have a critically urgent parcel
        delivery, whether its components, servers or other hardware, we can
        handle it – just as we can everything from engineering tools and
        equipment to emergency deliveries of medical equipment, supplies or
        general goods – wherever it needs to go. We offer a personalised
        scheduled courier service that is reliable 24 hours per day, 7 days per
        week. Our network of vehicles are all over the UK so we’re guaranteed to
        have the perfect courier to transport your package.
      </span>,
